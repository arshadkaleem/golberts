            ...
            <div className="about__inner">
              <div className="section__title section__title--2 sp_bottom_30">
                <div className="section__title__heading">
                  <h3>
                    GUIDING YOU EVERY STEP OF THE WAY AT{" "}
                    <span className="text__gradient">GLOBERTS.</span>{" "}
                  </h3>
                </div>
                <div className="section__title__text">
                  <p>
                    Globerts Visa & Immigration services was founded in 2023, is
                    dedicated to guiding applicants through the complexities of
              ...
              <div className="about__text__2">
                <p>
                  To become the leading global service provider in career,
                  travel, education, and immigration, guiding applicants towards
                  their dreams through legal and ethical pathways..
                </p>
              </div>
              <div className="about__text__3">
                <p>
                  To offer comprehensive and ethical services that avoid illegal
                  immigration. We aim to guide applicants in choosing the right
                  visa based on their career intentions, protecting them from
                  fraudulent activities, and only charging service fees
                  post-initiation of services.
                </p>
              </div>
